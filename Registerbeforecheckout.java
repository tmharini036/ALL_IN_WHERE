...
WebDriver driver;
	...
	public void test1() {
		...
		driver.findElement(By.className("btn btn-default")).click();
		driver.findElement(By.linkText("/view_cart")).click();
		driver.findElement(By.className("btn btn-default check_out")).click();
		driver.findElement(By.xpath("//button [@class = 'btn btn-success close-checkout-modal btn-block']")).click();
